...
const testIkey = "01234567-0000-89ab-cdef-000000000000"
...
func TestJsonSerializerEvents(t *testing.T) {
	...
	// Trace
	j[0].assertPath(t, "iKey", testIkey)
	...
	// Event
	j[1].assertPath(t, "iKey", testIkey)
	...
	// Metric
	j[2].assertPath(t, "iKey", testIkey)
	...
	// Request
	j[3].assertPath(t, "iKey", testIkey)
	...
	// Aggregate metric
	j[4].assertPath(t, "iKey", testIkey)
	...
	// Remote dependency
	j[5].assertPath(t, "iKey", testIkey)
	...
	// Availability
	j[6].assertPath(t, "iKey", testIkey)
	...
	// Page view
	j[7].assertPath(t, "iKey", testIkey)
...
func telemetryBuffer(items ...Telemetry) telemetryBufferItems {
	ctx := NewTelemetryContext(testIkey)
	ctx.iKey = testIkey
...
func (tbis *telemetryBufferItems) add(items ...Telemetry) {
	*tbis = append(*tbis, telemetryBuffer(items...)...)
}
