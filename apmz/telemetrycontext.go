...
type TelemetryContext struct {
	// iKey is an instrumentation key
	iKey string

	// nameIKey stripped-down instrumentation key used in envelope name
	nameIKey string
...
// InstrumentationKey gets the instrumentation key associated with this TelemetryContext.  This
