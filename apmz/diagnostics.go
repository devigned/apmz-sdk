...
// DiagnosticsMessageHandler is a handler function for receiving diagnostics messages.  If this returns an
...
// NewDiagnosticsMessageListener subscribes the specified handler to diagnostics messages from the SDK.  The
