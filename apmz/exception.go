...
// NewExceptionTelemetry creates a new exception telemetry item with the specified error and the
...
// GetCallstack generates a callstack suitable for inclusion in Application Insights
...
// TrackPanic recovers from any active panics and tracks them to the specified
